...
public partial class Tutorial : IPublishable
{
    ...
    private bool HasReadableAssets => Assets.Any(asset => asset.Readable);
    private bool HasViewableAssets => Assets.Any(asset => asset.Viewable);
    ...
    private bool ExistsReadableContent(string readableContent)
    {
