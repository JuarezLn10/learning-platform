    ...
    ITutorialQueryService tutorialQueryService) : ControllerBase
{
    ...
    [SwaggerOperation(
        ...
        Description = "Creates a new tutorial and returns it.",
    ...
    public async Task<IActionResult> CreateTutorial([FromBody] CreateTutorialResource resource)
    {
        ...
        if (tutorial is null)
            return BadRequest("Tutorial could not be created.");
    ...
    [SwaggerResponse(StatusCodes.Status400BadRequest, "Video could not be added to tutorial.")]
        ...
        [FromRoute] int tutorialId)
    {
        ...
        if (tutorial is null)
            return BadRequest("Video could not be added to tutorial.");
